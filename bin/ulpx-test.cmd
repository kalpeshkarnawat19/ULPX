...
if %errorlevel% equ 0 (
    python "%ENGINE_ROOT%\scripts\audit.py" %*
    exit /b %errorlevel%
)
...
if %errorlevel% equ 0 (
    python3 "%ENGINE_ROOT%\scripts\audit.py" %*
    exit /b %errorlevel%
)

:: Direct fallback for standard Windows installation paths (e.g., C:\Python314\python.exe)
if exist "C:\Python314\python.exe" (
    "C:\Python314\python.exe" "%ENGINE_ROOT%\scripts\audit.py" %*
    exit /b %errorlevel%
)

if exist "C:\Python313\python.exe" (
    "C:\Python313\python.exe" "%ENGINE_ROOT%\scripts\audit.py" %*
    exit /b %errorlevel%
)
